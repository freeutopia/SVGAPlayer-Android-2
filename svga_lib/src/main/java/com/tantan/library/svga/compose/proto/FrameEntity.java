...
public final class FrameEntity extends Message<FrameEntity, FrameEntity.Builder> {
  ...
  /** 初始约束大小 */
  @WireField(tag = 2, adapter = "com.tantan.library.svga.compose.proto.Layout#ADAPTER")
  public final Layout layout;

  /** 2D 变换矩阵 */
  @WireField(tag = 3, adapter = "com.tantan.library.svga.compose.proto.Transform#ADAPTER")
  ...
  public FrameEntity(
      Float alpha, Layout layout, Transform transform, String clipPath, List<ShapeEntity> shapes) {
  ...
  public static final class Builder extends Message.Builder<FrameEntity, Builder> {
    ...
    public FrameEntity build() {
      return new FrameEntity(
          alpha, layout, transform, clipPath, shapes, super.buildUnknownFields());
    }
  }
