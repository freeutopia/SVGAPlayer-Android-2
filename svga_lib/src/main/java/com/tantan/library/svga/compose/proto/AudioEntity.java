...
public final class AudioEntity extends Message<AudioEntity, AudioEntity.Builder> {
  ...
  public AudioEntity(
      String audioKey, Integer startFrame, Integer endFrame, Integer startTime, Integer totalTime) {
  ...
  public static final class Builder extends Message.Builder<AudioEntity, Builder> {
    ...
    public AudioEntity build() {
      return new AudioEntity(
          audioKey, startFrame, endFrame, startTime, totalTime, super.buildUnknownFields());
    }
  }
  ...
  private static final class ProtoAdapter_AudioEntity extends ProtoAdapter<AudioEntity> {
    ...
    public int encodedSize(AudioEntity value) {
      return (value.audioKey != null
              ? ProtoAdapter.STRING.encodedSizeWithTag(1, value.audioKey)
              : 0)
          + (value.startFrame != null
              ? ProtoAdapter.INT32.encodedSizeWithTag(2, value.startFrame)
              : 0)
          + (value.endFrame != null ? ProtoAdapter.INT32.encodedSizeWithTag(3, value.endFrame) : 0)
          + (value.startTime != null
              ? ProtoAdapter.INT32.encodedSizeWithTag(4, value.startTime)
              : 0)
          + (value.totalTime != null
              ? ProtoAdapter.INT32.encodedSizeWithTag(5, value.totalTime)
              : 0)
