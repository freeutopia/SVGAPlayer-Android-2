...
package com.tantan.library.svga.compose.proto;
...
public final class ShapeEntity extends Message<ShapeEntity, ShapeEntity.Builder> {
  ...
  /** 矢量图层 2D 变换矩阵 */
  @WireField(tag = 11, adapter = "com.tantan.library.svga.compose.proto.Transform#ADAPTER")
  ...
  public static final class Builder extends Message.Builder<ShapeEntity, Builder> {
    ...
    public ShapeEntity build() {
      return new ShapeEntity(
          type, styles, transform, shape, rect, ellipse, super.buildUnknownFields());
    }
  }
  ...
  public enum ShapeType implements WireEnum {
    ...
    public static final ProtoAdapter<ShapeType> ADAPTER =
        ProtoAdapter.newEnumAdapter(ShapeType.class);
  ...
  public static final class ShapeArgs extends Message<ShapeArgs, ShapeArgs.Builder> {
    ...
    public boolean equals(Object other) {
      ...
      return unknownFields().equals(o.unknownFields()) && Internal.equals(d, o.d);
    }
  ...
  public static final class RectArgs extends Message<RectArgs, RectArgs.Builder> {
    ...
    public RectArgs(
        Float x, Float y, Float width, Float height, Float cornerRadius, ByteString unknownFields) {
      super(ADAPTER, unknownFields);
      this.x = x;
      this.y = y;
      this.width = width;
  ...
  public static final class ShapeStyle extends Message<ShapeStyle, ShapeStyle.Builder> {
    ...
    /** 尖角限制 */
    @WireField(tag = 6, adapter = "com.squareup.wire.ProtoAdapter#FLOAT")
    public final Float miterLimit;

    /** 虚线参数 Dash */
    @WireField(tag = 7, adapter = "com.squareup.wire.ProtoAdapter#FLOAT")
    public final Float lineDashI;

    /** 虚线参数 Gap */
    @WireField(tag = 8, adapter = "com.squareup.wire.ProtoAdapter#FLOAT")
    public final Float lineDashII;

    /** 虚线参数 Offset */
    @WireField(tag = 9, adapter = "com.squareup.wire.ProtoAdapter#FLOAT")
    ...
    public enum LineCap implements WireEnum {
      ...
      public static final ProtoAdapter<LineCap> ADAPTER =
          ProtoAdapter.newEnumAdapter(LineCap.class);
    ...
    public enum LineJoin implements WireEnum {
      ...
      public static final ProtoAdapter<LineJoin> ADAPTER =
          ProtoAdapter.newEnumAdapter(LineJoin.class);
